...
import ImgProfile from '../../../images/anuj.jpg';
		...
		<div>
			<div className='card'>
				<div className='card-image'>
					<img className='activator' src={ImgProfile} alt='Anuj Sharma' />
				...
				<div className='card-reveal'>
					...
					<p className='flex-container'>
						<i href='https://www.w3schools.com' className='fab fa-facebook-f grey-text text-darken-4 social_style'></i>
